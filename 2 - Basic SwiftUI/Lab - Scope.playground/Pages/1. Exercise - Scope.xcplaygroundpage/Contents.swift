...
// becasue it is not in the scope
...
// becasue the x is in the scope of the print so print can see x while above foo print could not see foo becasue it is not in the scope of x
// it is modified in the for scope and foo is defined in the for scope and used in the for scope to
...
greeting(greeting: "Hi there", name: "Joey")
greeting(greeting: nil, name: "Joey")
