...
// becasue the x is in the scope of the print so print can see x while above foo print could not see foo becasue it is not in the scope
// it is modified in the for scpoe and foo is defined in the for scope and used in the for scope to
