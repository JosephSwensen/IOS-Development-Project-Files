 ...
 */
var walkingChallenges = ["walk 3 miles a day", "walk 5 miles at least onece a week"]
var runningChallenges = ["run 6 miles", "run every day of the week"]
...
var committed = ["run 6 miles", "walk every day"]
