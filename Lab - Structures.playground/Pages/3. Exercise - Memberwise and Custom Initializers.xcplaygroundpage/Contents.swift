...
var favoriteBook = Book(title: "Harry Potter", author: "J.K Rolling", pages: 367, price: 11.99)
...
struct Laptop {
    ...
    var repairCoount: Int = 0
    var yearPurchased: Int
}

var myLaptop = Laptop(screenSize: 18, yearPurchased: 2025)
var yourLaptop = Laptop(screenSize: 24, yearPurchased: 2026)
/*:
