...
progressUpdate(steps: 2000, goal:5000)
...
func pacing(currentDistance: Double, totalDistance: Double, currentTime: Double, goalTime: Double) {
    let distanceProgress = currentDistance / totalDistance
    let timeProgress = currentTime / goalTime
...
pacing(currentDistance: 5, totalDistance: 10, currentTime: 20.03, goalTime: 40.00)
